...
socket.on('chosenPlayer', drawingPlayer => {
    ...
    if (drawingPlayer === pName) {
        ...
        canDraw = false;
        loginContainer.innerHTML = `
            <div style="width: fit-content; height: fit-content; padding-left: 30px; padding-right: 30px; background-color: white;" class="loginArea">
                <br>
                <h1>${drawingPlayer} está eligiendo una palabra</h1>
            </div>
        `;
    }
});
